...
<body>
	...
	<nav class="breadcrumb">
		...
		管理员管理 <span class="c-gray en">&gt;</span>审核员列表 <a
	...
	<div class="page-container">
		...
		<form action="deleteAdmin.action" id="deleteForm" method="post">
		<table class="table table-border table-bordered table-bg">
			...
			<tbody>
				<c:forEach items="${auditor}" var="auditor">
					<tr class="text-c">
						<td><input type="checkbox" value="${auditor.id}" name="id" id="id"></td>
						<td>${auditor.id}</td>
						<td>${auditor.username}</td>
						<td>${auditor.phone}</td>
						<td>${auditor.rparea}</td>
						<td>审核员</td>
	...
	<script type="text/javascript">
		...
		function admin_del(obj) {
			...
			layer.confirm('确认要删除吗？', function(index) {
				$.ajax({
					type : 'POST',
					url : '${pageContext.request.contextPath}/delAdmin.action',
					dataType : 'text',
					data:{
						id:a
					},
